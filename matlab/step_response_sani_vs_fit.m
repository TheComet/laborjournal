...
g_normal = step(sani_transfer_function(T, r, n), xdata);
[T, r] = sani_fit(T, r, n, xdata_raw, ydata_raw);
g_fit = step(sani_transfer_function(T, r, n), xdata);
...
title('\fontsize{16}Sani vs  Fit, Noise=20%');
...
legend('Input Data', 'Correct Response', 'Sani Tu / Tg', 'Sani Fit', 'Error of Sani Tu / Tg', 'Error of Sani Fit', 'Location', 'east');


[xdata, ydata] = preprocess_curve(xdata_raw, ydata_orig);
[Tu, Tg] = characterise_curve(xdata, ydata);
[T, r, n] = sani_lookup(Tu, Tg);
g_normal = step(sani_transfer_function(T, r, n), xdata);
[T, r] = sani_fit(T, r, n, xdata_raw, ydata_orig);
g_fit = step(sani_transfer_function(T, r, n), xdata);
...
xlabel('\fontsize{14}Time');
ylabel('\fontsize{14}Amplitude');
title('\fontsize{16}Sani vs  Fit, Noise=0%');
